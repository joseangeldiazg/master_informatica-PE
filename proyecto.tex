...
\newcommand{\myName}{José Ángel Díaz García}
\newcommand{\myProf}{Pedro Villar Castro (tutor académico)}
\newcommand{\myOtherProf}{Miguel Garcia Silvente (tutor empresa)}
\newcommand{\myFaculty}{Escuela Técnica Superior de Ingenierí­as Informática y de Telecomunicación}
...
pdftitle = {\myTitle},
pdfsubject = {},
pdfkeywords = {prácticas_empresa, memoria, Oficina Web },
...
%Para conseguir que en las pÃ¡ginas en blanco no ponga cabecerass
\makeatletter
\def\clearpage{%
  \ifvmode
